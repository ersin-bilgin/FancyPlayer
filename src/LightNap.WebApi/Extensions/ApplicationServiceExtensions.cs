...
using LightNap.Core.Streaming.Services;
using LightNap.Core.Users.Interfaces;
using LightNap.Core.Users.Services;
using LightNap.DataProviders.PostgreSQL.Extensions;
...
namespace LightNap.WebApi.Extensions
{
    ...
    public static class ApplicationServiceExtensions
    {
        ...
        public static IServiceCollection AddDatabaseServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            switch (databaseProvider)
            {
                ...
                case "SqlServer":
                    ...
                    break;
                case "PostgreSQL":
                    services.AddLightNapPostgreSQL(configuration);
                    break;
        ...
        /// <summary>
        /// Adds Redis distributed cache to the service collection.
        /// </summary>
        /// <param name="services">The service collection.</param>
        /// <param name="configuration">The configuration.</param>
        /// <returns>The updated service collection.</returns>
        public static IServiceCollection AddRedisCache(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddStackExchangeRedisCache(options =>
            {
                ...
                options.InstanceName = "LightNap:";
            });

            // Also register IConnectionMultiplexer for direct Redis access if needed
